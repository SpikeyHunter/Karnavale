<script lang="ts">
	...
	// Fires on every SvelteKit client-side navigation. Hard page loads are
	// already covered by the Preloader (which sits at a higher z-index), so
	// this only ever shows for in-app nav.
	$effect(() => {
